    ...
    <div class="modal productModal fade" id=${product.id} tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer modal-footer d-flex">
              <a href="https://api.whatsapp.com/send?phone=573108306999" style="background: #50c14e" class="text-white btn ml-5 mr-5 w-50 " target="_blank">Contáctanos&nbsp;<i class="fa fa-whatsapp" aria-hidden="true"></i></a>
